...
class TestPipelineState:
    ...
    def test_create_initial_state_with_report_path(self):
...
class TestDiscrepancyHistory:
    ...
    def test_history_size_limit(self):
        ...
        history = DiscrepancyHistory(max_size=5)
...
class TestDiscrepancyResult:
    ...
    def test_discrepancy_result_creation(self):
    ...
    def test_discrepancy_result_frozen(self):
